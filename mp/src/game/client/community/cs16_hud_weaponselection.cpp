...
#define CS_MAX_WEAPON_SLOTS	6

//-----------------------------------------------------------------------------
// Purpose: CS1.6 weapon selection hud element
//-----------------------------------------------------------------------------
...
private:
	...
	CHudTexture		*icon_buckets[ CS_MAX_WEAPON_SLOTS ];
...
void CHudWeaponSelection::VidInit()
{
	...
	for ( int i = 0; i < CS_MAX_WEAPON_SLOTS; i++ )
	{
		char szNumString[ 10 ];
...
C_BaseCombatWeapon *CHudWeaponSelection::FindNextWeaponInWeaponSelection(int iCurrentSlot, int iCurrentPosition)
{
	...
	int iLowestNextSlot = CS_MAX_WEAPON_SLOTS;
...
void CHudWeaponSelection::CycleToPrevWeapon( void )
{
	...
	if ( !pNextWeapon )
	{
		...
		pNextWeapon = FindPrevWeaponInWeaponSelection( CS_MAX_WEAPON_SLOTS, MAX_WEAPON_POSITIONS );
	}
