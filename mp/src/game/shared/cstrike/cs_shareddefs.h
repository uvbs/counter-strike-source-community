...
#define WEAPON_SLOT_RIFLE		WEAPON_PRIMARY_SLOT	// (primary slot)
#define WEAPON_SLOT_PISTOL		WEAPON_SECONDARY_SLOT	// (secondary slot)
#define WEAPON_SLOT_KNIFE		WEAPON_MELEE_SLOT
#define WEAPON_SLOT_GRENADES	WEAPON_EXPLOSIVE_SLOT
#define WEAPON_SLOT_C4			WEAPON_TOOL_SLOT
